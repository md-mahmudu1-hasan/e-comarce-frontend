    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4">
          ...
          {clothes.map((product) => (
            ...
            >
              <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border border-gray-100 cursor-pointer h-full flex flex-col relative">
                {/* Discount Badge */}
                <div className="absolute top-3 right-3 z-10 bg-linear-to-r from-orange-500 to-orange-600 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg">
                  {product.discount}% OFF
                </div>

                {/* Product Image */}
                <div className="w-full h-40 overflow-hidden relative bg-linear-to-br from-gray-50 to-gray-100">
                  <img
                ...
                <div className="flex-1 flex flex-col justify-between p-4">
                  ...
                  <div className="space-y-2 pt-2 border-t border-gray-100">
                    <div className="flex items-baseline gap-2">
                      <span className="text-lg lg:text-xl font-bold bg-linear-to-r from-green-600 to-orange-600 bg-clip-text text-transparent">
        ...
        <div className="text-center">
          <Link
            to="/all-clothes"
            className="bg-transparent text-green-700 px-8 py-3 border-2 border-green-700 rounded-lg font-semibold text-lg hover:bg-green-700 hover:text-white transition-all duration-300 hover:-translate-y-1"
          >
            All Products
          </Link>
        </div>
