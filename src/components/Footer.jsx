...
const Footer = () => {
  return (
    <footer className="bg-linear-to-r from-green-600 to-orange-500 text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          ...
          <img src="/logo.png" alt="ShopHub Logo" className="w-35 px-4" />
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-white/20 hover:bg-white/30 backdrop-blur rounded-full flex items-center justify-center transition-colors">
